...
zipsByProduct(dpID="DP1.10026.001", site="all", package="basic")
...
zipsByProduct(dpID="DP1.10078.001", site="all", package="basic")
...
zipsByProduct(dpID="DP1.10080.001", site="all", package="basic")
stackByTable(filepath="filesToStack10080/", folder=T)

# Download and stack litter chemical properties: DP1.10031.001
zipsByProduct(dpID="DP1.10031.001", site="all", package="basic")
...
zipsByProduct(dpID="DP1.10047.001", site="all", package="basic")
